      ...
      <Router>
        <div >
          ...
          <div className="head about" >
            ...
            <a href="tel:962785495939"> &#9990; +(962) 785 495 939</a>
            <a href="tel:962780950198"> &#9990; +(962) 780 950 198</a>
            <h4>LIFE STYLE</h4>
          ...
          <div className="head">
            ...
            <ul className="skills">
              ...
              <li>&#10147;Flexible, Adaptive & Open to Constructive Criticism</li>
            </ul>
          </div>
          <div id="PROJECTS" className="head">
            <h2>PROJECTS</h2>
            <h4>Online.com</h4>
          ...
          <div id="EDUCATION" className="head">
            ...
            <p>Graduated at 2018</p>
          </div >
          <div id="INTERESTS" className="head" >
            ...
            <p> <span className=" bg-dark text-primary"> BESSLAN BZADOUGH  :</span>
              ...
              <span className="text-secondary">/Insructor in Meraki Academy </span> </p>
            <p> <span className=" bg-dark text-primary"> Bader Sabbagh :</span><span className="text-secondary"> (+962)  782 659 211  </span></p>
